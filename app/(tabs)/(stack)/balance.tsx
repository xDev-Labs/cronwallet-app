    ...
    return (
      <SafeAreaView className="flex-1 bg-gray-50">
        <View className="flex-1 items-center justify-center px-6">
          ...
          <Text variant="h2" className="text-center mb-4 text-foreground-dark">
    ...
    <SafeAreaView className="flex-1 bg-gray-50" edges={["top"]}>
      <View className="">
        <View className="flex-row items-center px-4 py-3">
          ...
          <Text
            variant="h3"
            className="flex-1 text-black text-center mr-8 font-semibold"
          >
            Wallet Balance
          </Text>
        </View>
      ...
      >
        <View className="px-4 py-6">
          <View
            className="bg-primary flex-row justify-between  rounded-3xl p-6 mb-8 shadow-lg"
            style={{
              shadowColor: "#4A3DFF",
          ...
          >
            <View>
              <Text className="text-white/80 mb-2 text-sm font-medium">
              ...
              <Text className="text-white/60 mt-1">
                ≈ ₹{formatValue(totalValueUSD * 83.5)}
              </Text>
            </View>
            ...
            <View className="flex-row items-center justify-end gap-2">
              ...
              <Pressable className="p-2 active:opacity-70" onPress={onRefresh}>
          ...
          <Text
            variant="h4"
            className="mb-4 font-semibold text-foreground-dark"
          >
            Your Assets
          </Text>
