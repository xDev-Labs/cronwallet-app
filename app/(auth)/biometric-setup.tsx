                ...
                <View className="flex-1 justify-between bg-background-light mt-20">
                    ...
                    <View className="flex-1 px-6 justify-center">
                        <View className="items-center mb-12">
                            ...
                            <Text variant="caption" className="font-sans text-foreground-tertiary text-center leading-6 mb-8">
                            ...
                            {isAvailable && !isEnrolled && (
                                <View className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                                    <Text className="text-blue-800 text-sm text-center">
                                        Please set up {biometricType === 'faceId' ? 'Face ID' : 'Touch ID'} in your device settings first
                                    </Text>
                                </View>
                            )}
                        </View>
